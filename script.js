...
// const run1 = new Running([41, 51], 5, 2, 15);
// const by1 = new Cycling([41, 51], 15, 3, 30);
// console.log(run1);
// console.log(by1);
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Inputs have to be poistive numbers!');
    ...
    // Hide form + Cleat input fields
    this._hideForm();

    // Strore data in locale storage
